...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////       
	...
	function createtable(records){
				...
				// console.log(records.length)
		  	    var str =  "<thead style='background-color: #008282;'>\n\
            	...
            	<th width='10%'>Action</th>\n\
            		...
            		if(records.length > 0) { 
            				for(var i=0; i < records.length; i++) {
                                ...
                                <button type='button' ID='btnreset' class='btn-edit btn--animated' style='background-color:#FF8119; color:white; width: 50px; height:40px;'  data-id='" + records[i]._id + "' data-name='" + records[i].userName + "'  data-toggle='modal' data-toggle='modal' data-target='#central-confirm-reset'><i class='fa fa-refresh' aria-hidden='true' style='margin-left:-20px; margin-top:2px ;font-size:30px;'></i></button>\n\
                                <button type='button' ID='btnedit' class='btn-edit btn--animated' style='background-color:#26b600; color:white; width: 50px; height:40px;'  data-id='" + records[i]._id + "' onclick=\"frm.Fn_Edit('" + records[i]._id + "');\" ><i class='fa fa-pencil-square-o' aria-hidden='true' style='margin-left:-20px; margin-top:2px ;font-size:30px;'></i></button>\n\
                                <button type='button' ID='btndel'  class='btn-edit btn--animated' style='background-color:#ff001e; color:white; width: 50px; height:40px;'  data-id='" + records[i]._id + "' data-name='" + records[i].userName + "'  data-toggle='modal' data-target='#central-confirm-delete'><i class='fa fa-trash-o' aria-hidden='true' style='margin-left:-20px; margin-top:2px ;font-size:30px;'></i></button>\n\
                                </td></div>\n\
                            	</tr>";	  
            				};
            		}else {
